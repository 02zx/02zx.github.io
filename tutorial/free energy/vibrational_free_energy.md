...
```bash
mkdir $i
echo "3"|gmx_mpi velacc -f ./md/$i.trr -s ./md/$i.tpr  -o ./$i/O.xvg -n ./ndx/${i}.ndx -dt 0.01 -b 40 -nonormalize -norecip
echo "4"|gmx_mpi velacc -f ./md/$i.trr -s ./md/$i.tpr  -o ./$i/HW.xvg -n ./ndx/${i}.ndx -dt 0.01 -b 40 -nonormalize -norecip
